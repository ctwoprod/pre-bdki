 ...
 * 
 * @author dbejar Series of String constants for the messages to be shown on the
 *         client side.
 */
public final class CoreExceptionText{

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2489295411838451425L;
	...
	public static String getMessage(String message, String... arguments) {
		...
		if (arguments != null) {
			for (int i = 0; i < arguments.length; i++) {
				result = StringUtils.replace(result, "{" + i + "}", arguments[i]);
			}
		}
		return result;
	}
