package org.fernandez.roberto.bdki.dao.core;
...
public interface FindLayerDAO<T> extends CountLayerDAO<T> {
	 ...
	 * @author roberto
	 */
	List<T> findByProperty(String propertyName, Object value, final int... rowStartIdxAndCount);
	 ...
	 */
	T findUniqueByProperty(String propertyName, Object value, List<String> leftJoinFetchColumns,
			LockMode lockMode);
	 ...
	 * @author roberto
	 */
	List<T> findByProperty(String propertyName, Object value, List<String> leftJoinFetchColumns,
	 ...
	 * @author roberto
	 */
	List<T> findLikeProperty(String propertyName, Object value, final int... rowStartIdxAndCount);
	 ...
	 * @author roberto
	 */
	List<T> findLikeProperty(String propertyName, Object value, List<String> leftJoinFetchColumns,
	 ...
	 * @return List<T>
	 * @author roberto
	 * @see es.cimsa.framework.common.vo.PropCriteriaAndValue
	 */
	List<T> findUsingFilter(List<PropCriteriaAndValue> filter, final int... rowStartIdxAndCount);
	 ...
	 * @author roberto
	 */
	List<T> findUsingFilter(List<String> leftJoinFetch, List<PropCriteriaAndValue> filter,
			List<QueryOrder> orders, final int... rowStartIdxAndCount);
