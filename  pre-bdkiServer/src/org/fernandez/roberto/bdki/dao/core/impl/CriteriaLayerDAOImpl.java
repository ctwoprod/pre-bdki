...
import org.fernandez.roberto.bdki.common.QueryOrderDirection;
import org.fernandez.roberto.bdki.dao.core.CriteriaLayerDAO;
 ...
 * 
 */
public class CriteriaLayerDAOImpl<T> extends KernelDAOImpl<T> implements
		CriteriaLayerDAO<T> {
	 ...
	 *            annotation
	 */
	public CriteriaLayerDAOImpl(Class<T> clazz, SessionFactory sessionFactory) {
	...
	static {
		CRITERION_CREATOR_MAP.put(QueryComparator.EQUALS, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.eq(propertyName, value);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.GREATER_OR_EQUAL, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.ge(propertyName, value);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.GREATER_THAN, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.gt(propertyName, value);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.LESS_THAN, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.lt(propertyName, value);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.LESS_OR_EQUAL, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.le(propertyName, value);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.NOT_EQUAL, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
		...
		CRITERION_CREATOR_MAP.put(QueryComparator.BETWEEN, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
		...
		CRITERION_CREATOR_MAP.put(QueryComparator.IS_NOT_NULL, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.isNotNull(propertyName);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.IS_NULL, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
				return Restrictions.isNull(propertyName);
			}
		});
		CRITERION_CREATOR_MAP.put(QueryComparator.SQL_STRING_RESTRICTION, new CriterionCreator() {
			public Criterion create(String propertyName, Object value) {
	...
	protected static Criterion createBetweenCriterion(String propName, Object propValue) {
	 ...
	 */
	@SuppressWarnings(UNCHECKED)
	protected static Criterion createInCriterion(String propName, Object propValue) {
	 ...
	 * @author yosi
	 */
	protected Criteria createHibernateCriteriaObject(List<String> leftJoinFetch,
	 ...
	 * @author dbejar
	 */
	protected Criteria addPaginationToCriteria(Criteria criteria, final int... rowStartIdxAndCount) {
	 ...
	 * @return the criteria
	 */
	protected static Criteria addLeftJoinFetchPhraseToCriteria(Criteria criteria,
	 ...
	 * @author dbejar
	 */
	protected static Criteria addOrderToCriteria(Criteria criteria, List<QueryOrder> orders) {
		for (QueryOrder order : orders) {
			...
			switch (order.getDirection()) {
				...
				default:
					...
					throw new UnsupportedOperationException("Query direction not ASC not DESC!!");
			}
		}
		return criteria;
	}
	 ...
	 */
	private static void addOrderToSubCriteria(Criteria criteria, QueryOrder order) {
		...
		for (int i = 0; i < length; i++) {
			...
			if (remaining == 2) {
				Criteria subCriteria = parentCriteria.createCriteria(properties[i]);
