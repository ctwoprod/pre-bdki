...
import org.fernandez.roberto.bdki.dao.core.FindLayerDAO;
...
public class FindLayerDAOImpl<T> extends CountLayerDAOImpl<T> implements	FindLayerDAO<T> {
	 ...
	 *            annotation
	 */
	public FindLayerDAOImpl(Class<T> clazz, SessionFactory sessionFactory) {
	...
	public List<T> findByMapOfProperties(Map<String, ? extends Object> propertiesMap,
		...
		return findByMapOfProperties(propertiesMap, null, orders, null, rowStartIdxAndCount);
	}
	...
	public List<T> findByMapOfProperties(Map<String, ? extends Object> propertiesMap,
		...
		return doQueryForMaps(queryString.toString(), QueryComparator.EQUALS, propertiesMap,
				orders, lockMode, null, rowStartIdxAndCount);
	}
	...
	public List<T> findLikeMapOfProperties(Map<String, ? extends Object> propertiesMap,
		...
		queryString.append(createLeftJoinFetchPhrase(leftJoinFetchColumns));
		queryString.append(WHERE);
		return doQueryForMaps(queryString.toString(), QueryComparator.LIKE, propertiesMap, orders,
	 ...
	 */
	@Override
	public List<T> findByProperty(String propertyName, Object value, List<QueryOrder> orders,
			final int... rowStartIdxAndCount) {
		return findByProperty(propertyName, value, null, orders, null, rowStartIdxAndCount);
	}
	...
	public List<T> findByProperty(String propertyName, Object value, List<QueryOrder> orders,
		...
		return findByProperty(propertyName, value, null, orders, lockMode, rowStartIdxAndCount);
	}
	 ...
	 */
	@Override
	public List<T> findLikeProperty(String propertyName, Object value, List<QueryOrder> orders,
			final int... rowStartIdxAndCount) {
	...
	public List<T> findLikeProperty(String propertyName, Object value,
			List<String> leftJoinFetchColumns, List<QueryOrder> orders,
			final int... rowStartIdxAndCount) {
		return (List<T>) findGenericUsingProperty(propertyName, QueryComparator.LIKE, value,
				leftJoinFetchColumns, orders, null, null, rowStartIdxAndCount);
	}
	...
	public List<T> findByProperty(String propertyName, Object value,
			List<String> leftJoinFetchColumns, List<QueryOrder> orders, LockMode lockMode,
			final int... rowStartIdxAndCount) {
		return (List<T>) findGenericUsingProperty(propertyName, QueryComparator.EQUALS, value,
				leftJoinFetchColumns, orders, lockMode, null, rowStartIdxAndCount);
	}
	 ...
	 *             if there is more than one matching result
	 */
	private Object findGenericUsingProperty(String propertyName, QueryComparator comparator,
			Object value, List<String> leftJoinFetchColumns, List<QueryOrder> orders,
			LockMode lockMode, Boolean uniqueResult, final int... rowStartIdxAndCount) {
	...
	@Override
	@SuppressWarnings(UNCHECKED)
	public List<T> findUsingFilter(List<PropCriteriaAndValue> filter, List<QueryOrder> orders,
			final int... rowStartIdxAndCount) {
		Criteria criteria = createHibernateCriteriaObject(null, filter, orders, rowStartIdxAndCount);
	...
	@Override
	@SuppressWarnings(UNCHECKED)
	public List<T> findUsingFilter(List<String> leftJoinFetch, List<PropCriteriaAndValue> filter,
			List<QueryOrder> orders, final int... rowStartIdxAndCount) {
